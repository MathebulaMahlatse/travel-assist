import * as travelUtil from '../travelUtils';
    ...
    describe('getCities', () => {
        it('should get cities', () => {
            const expectedCities =   {
                arrival: ["Amsterdam", "Paris", "Warsaw", "Brussels", "London", "Stockholm", "Prague", "Moscow", "Madrid", "Geneva", "Budapest", "Kiev", "Lisbon", "Rome", "Athens", "Istanbul"],
                departure: ["London", "Amsterdam", "Warsaw", "Stockholm", "Paris", "Brussels", "Prague", "Moscow", "Madrid", "Geneva", "Budapest", "Kiev", "Lisbon", "Rome", "Athens", "Istanbul"]};

            expect(travelUtil.getCities(deals)).toEqual(expectedCities);
        })
    });
    ...
    describe('getConnectedRoutes', () => {
        [
            ...
            it(`should return connected routes for departure: ${trip.departure} and arrival: ${trip.arrival}`, () => {
                ...
                // Distance by the algorithm should equal total amount of connected routes
                expect(totalCost).toBe(shortestRoute.distance);

                expect(shortestRoute.path.length).toBe(connectedCities.length + 1)
